...
Internet / ISP (Telmex Infinitum)
   ...
   ┌─────┬─────┬─────────────────────┐
   │     │     │                     │
Port 2  Port 3  ...              Port 8
T440p  T430                      Parrot
VLAN20 VLAN20                   VLAN90
(PROD) (PROD)                (PENTEST)
```
...
| K3s Master | Lenovo T440p | K3s control-plane | VLAN 20 (10.10.20.x) |
| K3s Worker 1 | Lenovo T430 | K3s worker node | VLAN 20 (10.10.20.x) |
| Pentesting | T440p Parrot OS | Red team — isolated | VLAN 90 (10.10.90.x) |
