...
**Monitoring stack (T430 — Junio 2026 ✅):**

| Domain | Answer | Service |
|---|---|---|
| `monitoring.mgmt` | `10.10.10.10` | T430 monitoring server |
| `grafana.mgmt` | `10.10.10.10` | Grafana dashboards :3000 |
| `prometheus.mgmt` | `10.10.10.10` | Prometheus :9091 |
| `alertmanager.mgmt` | `10.10.10.10` | Alertmanager :9093 |
| `loki.mgmt` | `10.10.10.10` | Loki :3100 |
